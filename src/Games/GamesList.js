            ...
            return (
                <div className="game-card" key={game.game_id}>
                    ...
                    <div className="game-info">
                        <h3 className="game-main game-title"><a href={`https://www.google.com/search?q=${game.game_title.replace("+", "%2B").split(' ').join('+')}`} target="_blank" rel="noreferrer">{game.game_title}</a></h3>
