      ...
      <section className="InfoRow">
        <div className="col-lg-7">
          ...
          <p className="portfolio-p">
            After graduating from High School in North Carolina in 2018, I began
            a self-employed career in Content Creation and Streaming, which
            worked out well for me for a few years! In 2019 I moved to Arizona
            where I continued doing so, until I began pursuing knowledge in the
            tech industry, learning how to develop software and web
            applications.
          </p>
          <p className="portfolio-p">
            ...
            5 quick but knowledge packed months, have completed with a
          ...
          <p className="portfolio-p">
            ...
            challenge, and trying to find solutions (odd or not) to problems, or
            cleanup, and show I am able to solve technical challenges given for
